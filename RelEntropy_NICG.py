...
pylab.plot(F,RelEnt1[0,:], color="#9DBDFF", alpha = 0.7, label=r'$S\left(\breve{\rho}_\tau \vert \vert \breve{\rho}_\tau^{th} \right)$, $\alpha$=2', linewidth=5, marker = 'o')
pylab.plot(F,RelEnt1[1,:], color="#FFD7C4", alpha = 0.7, label=r'$S\left(\breve{\rho}_\tau \vert \vert \breve{\rho}_\tau^{th} \right)$, $\alpha$=3', linewidth=5, marker = 'o')
pylab.plot(F,RelEnt1[2,:], color="#FF9874", alpha = 0.7, label=r'$S\left(\breve{\rho}_\tau \vert \vert \breve{\rho}_\tau^{th} \right)$, $\alpha$=4', linewidth=5, marker = 'o')
...
plt.show()
fig.savefig("RelEntropy_NICG.pdf")